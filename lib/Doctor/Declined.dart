...
class Decl extends StatefulWidget {
  final String iid;
  final FirebaseUser user;
  Decl({Key key, @required this.iid, @required this.user}) : super(key: key);
  @override
  _DeclState createState() => _DeclState(iid: iid, user: user);
}

class _DeclState extends State<Decl> {
  _DeclState({Key key, @required this.iid, @required this.user});
  FirebaseUser user;
  String iid;
  int count = 1;
  int finish = 1;
    ...
    return Container(
        ...
        child: new Scaffold(
          appBar: AppBar(
            ...
            title: Text('Declined history of patients',
                style: TextStyle(
                    fontFamily: 'Varela',
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Container(
                              child: Text(
                                '${documents['decline reason'] ?? 'Not available'}',
                                style: TextStyle(
